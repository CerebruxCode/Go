...
/*
	Όταν θέτουμε ένα variable ως όρισμα σε μια function, στην πραγματικότητα η Go κάνει ένα αντίγραφο της τιμής
	που μεταβιβάζεται απο το όρισμα και τοποθετεί αυτήν την τιμή στη στοίβα για χρήση από τη function που καλείται.
	Δεν βάζει την ίδια τη variable στη στοίβα, μόνο ένα αντίγραφο της τιμής του.
