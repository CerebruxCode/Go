...
func main() {
	/*
		Ο τύπος [n]T είναι ένας πίνακας n τιμών τύπου Τ.
	...
	*/
	...
	fmt.Println(primes[:])                               // το ίδιο με fmt.Println(primes)
	fmt.Println(primes[:3])                              // δώσε τα στοιχεί πρίν την 3ή θέση
	...
	*/
	...
	/*
		...
		ευέλικτη άποψη των στοιχείων μιας array.
		Στην πράξη, τα Slices είναι πολύ πιο συχνές από τα Arrays.
	...
	*/
	var s0 []int
	// τύπωσε τον πίνακα, το μήκος και την χωρητικότητά της
	...
	*/
	...
	for kouti := 0; kouti < len(board); kouti++ {
		...
		// που ενώνει στοιχεία με ένα διαχωρηστικό που θέτουμε εμείς (μπορεί να είναι ένα κενό)
	}
...
func myRange() {
	...
	/*
		Η "range" ενώς βρόχου for, σαρρώνει μια "slice" ή σε "map".
