...
func main() {
	...
	/*
		...
		πίνακας κατακερματισμού ή λεξικό, οι χάρτες χρησιμοποιούνται
		για να αναζητήσετε μια τιμή από το αντίστοιχο κλειδί της (σαν μια μικρή βάση δεδομένων).
...
func myCustomMap() {
	...
	/*
		...
		Αν το κλειδί δε βρίσκεται στον χάρτη,
