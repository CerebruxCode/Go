...
// Η βιβλιοθήκη fmt που εισάγουμε μας παρέχει εργαλεία μορφοποίησης - προβολής δεδομένων

import "fmt"

// Ξεκινόντας μια γραμμή με τα "//" μπορούμε να προσθέσουμε ένα προσωπικό σχόλιο σε μια γραμμή

/*
 Αν θέλουμε πολλαπλές γραμμές όπως αυτό που διαβάζετε τώρα,
 τότε βάζουμε το σχόλιό μας ανάμεσα σε αυτά
*/
