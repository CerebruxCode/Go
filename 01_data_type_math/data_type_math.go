...
// Όλα τα υπόλοιπα αρχεία έχουν και αυτά δήλωση για το σε ποιό πακέτο(package) ανήκουν
package main
...
/*
 ...
 σχολίων τότε βάζουμε τον κώδικα μας
 ανάμεσα σε αυτά.
*/

func add(x int, y int) int { // δημιουργούμε μια δικιά μας συνάρτηση με όνομα add

	/*η συνάρτηση add παίρνει 2 ορίματα x και y τύπου integer και δίνουν έξοδο πάλι int
...
func main() { // η κύρια συνάρτηση που εκτελεί την εφαρμογή
	...
	σε ένα τερματικό. Το πρόγραμμα σας, όπως αυτό, μπορείτε να το τρέξετε σε τερματικό γράφοντας π.χ. go run data_type_math.go
	...
	*/
	...
	// Στην πραγματικότητα δε χρειάζεται να καθορίσετε τον τύπο δεδομένων, ούτε χρειάζεστε ερωτηματικό στο τέλος:
