...
// διεύθηνση που θα πληκτρολογεί ο χρήστης. Στο παρόν παράδειγμα έστω ότι έχουμε
// μια κεντρική σελίδα και μια υποσελίδα με όνομα "earth". Αυτές οι σελίδες φυσικά
// δεν υπάρχουν στο συστημά μας και τις φανταζόμαστε ως φακέλους τον έναν μέσα στον άλλον.
...
// Η http.Request διαχειρίζεται το άιτημα του επισκέπτη (client) και την αποθηκέυει στην "r"
...
Ανοίξτε τον browser σας και επισκευτείτε την σελίδα localhost:8080/ έπειτα και την σελίδα localhost:8080/earth
