...
ο φάκελος βρήσκεται εδώ που τρέχει και ο κώδικάς μας.)
...
func main() {
	...
	// Σημείωση: Η ιστοσελίδα που παρέχουμε διαθέτει και βίντεο που εκτελέιται αυτόματα. Θα χρειαστεί
...
ένα φυσιολογικό περιβάλλον και παραμέτρους. Οπότε δεν έχουμε σωστές παραμετρούς
τότε δεν χρειάζεται να τρέχουμε το func main() οπότε θα πρέπει να το πούμε νωρίς
στον χρήστη οτι δεν έχει δώσει σωστές παραμέτρους.

2)... συμβαίνει ένα σφάλμα το οποίο γνωρίζω ότι δεν μπορεί λόγο εξωγενών παραγόντων
να παραμερήσει. Ας υποθέσουμε ότι έχουμε ένα πρόγραμμα που δημιουργεί μια μικρογραφία
...
πηγη: https://stackoverflow.com/questions/33885235/should-a-go-package-ever-use-log-fatal-and-when
*/
