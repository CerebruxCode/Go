...
// Ένα constant είναι ενα variable η τιμή του οποίου δεν θέλουμε και δεν μπορεί να αλλάξει
const pi float64 = 3.14159265359

// Αλλά με τις constant, δεν μπορούμε να χρησιμοποιήσουμε τη
// συντομογραφία όπου δηλώνουμε και ταυτόχρονα
// αρχικοποιούμε με τον τελεστή ":=" όπως κάνουμε με τις variables
