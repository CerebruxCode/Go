...
/*
	...
	Οι λειτουργίες δεν έχουν πρόσβαση σε άλλες μεταβλητές εκτός αυτών
	πέρασε σε αυτό

	Παρακάτω ξεκινάμε δημιουργόντας μερικές δικές μας
*/
...
// Εδώ δείχνουμε μια function που θα καλέσει τhn  "panic" και
// θα την διαχειριστεί με την "recover"

func demPanic() {

	defer func() {

		// Εάν δεν έκανα εκτύπωση του μηνύματος, τίποτα δεν θα έδειχνε
...
func main() {
	...
	// Εδώ  a recursive function

	fmt.Println(factorial(4))

	// Η Defer όπως είπαμε εκτελεί μια λειτουργία μετά την ολοκλήρωση της func στην οποία καλείται
	// Η Defer μπορεί να χρησιμοποιηθεί για να δημιουργήσουμε μια func με έναν λογικό τρόπο
	// αλλά ταυτόχρονα για να εκτελέσουμε μια τελευταίας λειτουργία ως λειτουργία καθαρισμού
	...
	// Εδω χρησιμοποιούμε την recover() για να πιάσουμε το error που θα προκαλούσε η διαίρεση με 0
...
/*
	Οι αναβαλλόμενες function κλήσεις στοιχίζονται σε μια στοίβα.
	Όταν μια function επιστρέψει, οι αναβαλλόμενες κλήσεις της
	εκτελούνται με διαταξη last-in-first-out.
